# Contributing to paymenthub-ee-account-mapper

Thank you for your interest in contributing to the paymenthub-ee-account-mapper! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-account-mapper/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-account-mapper) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-account-mapper.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-account-mapper.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-account-mapper.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-account-mapper.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-account-mapper.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-account-mapper.git (push)
```
